        ...
        children: [
          ...
          Column(
            children: [
              ...
              Container(height: MediaQuery.of(context).orientation ==
                  Orientation.landscape
                  ? Get.size.height
                  : Get.size.height-(Get.size.width * 9 / 16)-100,color: const Color(0x10000000),
                width: Get.size.width,
                child: LiveRoomChat(roomId: int.parse(Get.parameters['roomid']!)))
            ],
          ),
        ],
      ),
