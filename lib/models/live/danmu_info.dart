...
class LiveDanmakuInfo{
  ...
  LiveDanmakuInfo({required this.code,required this.message,required this.ttl,required this.data});
...
class DanmakuInfoData{
  ...
  String token;
  List<HostInfo> hostList;
  DanmakuInfoData({required this.group,required this.businessId,required this.ttl,required this.refreshRate,required this.maxDelay,required this.token,required this.hostList});
...
class HostInfo{
  ...
  HostInfo({required this.host,required this.port,required this.wssPort,required this.wsPort});
